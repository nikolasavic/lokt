...
| L-201  | Auto-prune dead locks before acquire     | in-progress | If PID dead + same host, silently clean up stale lock instead of failing. Self-healing. beads:lokt-e01 |
